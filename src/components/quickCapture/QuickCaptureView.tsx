  ...
  return (
    <div className="flex-1 overflow-y-auto bg-neutral-50 dark:bg-notion-dark-bg p-4 sm:p-6 select-none">
      <div className="max-w-2xl mx-auto space-y-6">
        ...
        <div className="flex items-center justify-between px-4 py-2 rounded-2xl bg-white dark:bg-notion-dark-card border border-neutral-200 dark:border-neutral-800 text-xs">
          <div className="flex items-center space-x-2">
            <span className={`w-2 h-2 rounded-full ${notionApiKey ? 'bg-emerald-500 animate-ping' : 'bg-neutral-400'}`} />
            <span className="font-medium text-neutral-700 dark:text-neutral-300">
              {notionApiKey 
                ? `연결된 노션 워크스페이스 활성화됨 (${createdNotionResource?.databases?.length || 0}개 DB 감지)`
